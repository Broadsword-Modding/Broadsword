...
static_assert(offsetof(UI_Tier_C_ExecuteUbergraph_UI_Tier, K2Node_DynamicCast_AsBP_Half_Sword_Game_Mode) == 0x000018, "Member 'UI_Tier_C_ExecuteUbergraph_UI_Tier::K2Node_DynamicCast_AsBP_Half_Sword_Game_Mode' has a wrong offset!");
static_assert(offsetof(UI_Tier_C_ExecuteUbergraph_UI_Tier, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'UI_Tier_C_ExecuteUbergraph_UI_Tier::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(UI_Tier_C_ExecuteUbergraph_UI_Tier, CallFunc_PlayAnimation_ReturnValue) == 0x000028, "Member 'UI_Tier_C_ExecuteUbergraph_UI_Tier::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UI_Tier_C_ExecuteUbergraph_UI_Tier, CallFunc_BooleanAND_ReturnValue) == 0x000031, "Member 'UI_Tier_C_ExecuteUbergraph_UI_Tier::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
